...
namespace BulkyBook.Areas.Customer.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            IEnumerable<Product> productList = _unitOfWork.Product.GetAll(includeProperties: "Category,SubCategory,Subss");
        ...
        public IActionResult Details(int id)
        {
            var productFromDb = _unitOfWork.Product.GetFirstOrDefault
                (u => u.Id == id,includeProperties: "Category,SubCategory,Subss");
        ...
        public IActionResult Details(ShoppingCart CartObject)
        {
            ...
            {
                var productFromDb = _unitOfWork.Product.GetFirstOrDefault
               (u => u.Id == CartObject.Id, includeProperties: "Category,SubCategory,Subss");
                ShoppingCart cartObj = new ShoppingCart()
                {
                    Product = productFromDb,
                    ProductId = productFromDb.Id
